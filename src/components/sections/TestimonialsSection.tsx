...
export interface TestimonialsSectionProps {
   ...
   * @default "Experiencias de personas que utilizan ajEdu para descubrir recursos y compartir proyectos."
   */
  subtitle?: string;
  /**
...
export const TestimonialsSection: React.FC<TestimonialsSectionProps> = ({
  title = 'Una red que inspira a docentes de todo el mundo',
  subtitle = 'Experiencias de personas que utilizan ajEdu para descubrir recursos, compartir proyectos y llevar el ajedrez educativo al aula.',
  className,
  id = 'testimonials',
}) => {
