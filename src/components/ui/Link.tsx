 ...
 * and supports both internal and external links with consistent styling.
 *
...
export interface LinkProps extends Omit<React.AnchorHTMLAttributes<HTMLAnchorElement>, 'href'> {
  ...
  /** Kept for compatibility; links always render as real anchors */
  ...
  (
    {
      ...
      useDemoModal: _useDemoModal = true,
      forceDemo: _forceDemo = false,
      className = '',
      children,
      resolvePath = true,
      underlineOffset = 2,
      ...
      modalDescription: _modalDescription,
      onModalOpen: _onModalOpen,
      onModalClose: _onModalClose,
      onModalCopy: _onModalCopy,
      ...props
    },
    ref,
  ) => {
