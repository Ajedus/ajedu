...
export const post10: BlogPost = {
  ...
  content: `
    ...
    <figure>
      <img src="${imageBase}/ajedrez-japones-damas-siglo-xix-01.webp" alt="Ajedrez japonés y juego de damas del siglo XIX" loading="lazy" />
    ...
    <figure>
      <img src="${imageBase}/ajedrez-harry-potter-01.webp" alt="Ajedrez temático de Harry Potter" loading="lazy" />
    ...
    <figure>
      <img src="${imageBase}/ajedreces-mexicanos-halloween-01.webp" alt="Ajedrez mexicano de Halloween con tablero temático" loading="lazy" />
      <figcaption>Tablero y piezas inspirados en una estética festiva y popular.</figcaption>
    </figure>
    <figure>
      <img src="${imageBase}/ajedreces-mexicanos-halloween-02.webp" alt="Piezas de ajedrez mexicano de Halloween" loading="lazy" />
    </figure>
    <figure>
      <img src="${imageBase}/ajedreces-mexicanos-halloween-03.webp" alt="Detalle de piezas de ajedrez de Halloween" loading="lazy" />
    </figure>
    <figure>
      <img src="${imageBase}/ajedreces-mexicanos-halloween-04.webp" alt="Ajedrez de Halloween con personajes temáticos" loading="lazy" />
    </figure>
    <figure>
      <img src="${imageBase}/ajedreces-mexicanos-halloween-05.webp" alt="Ajedrez artesanal de Halloween" loading="lazy" />
    </figure>
    ...
    <figure>
      <img src="${imageBase}/ajedrez-ceramica-medievo-01.webp" alt="Ajedrez de cerámica inspirado en el Medievo" loading="lazy" />
    ...
    <figure>
      <img src="${imageBase}/piezas-colombianas-plastilina-01.webp" alt="Piezas de ajedrez colombianas hechas con plastilina" loading="lazy" />
      <figcaption>Piezas modeladas manualmente bajo la idea de la magia del ajedrez.</figcaption>
    </figure>
    <figure>
      <img src="${imageBase}/piezas-colombianas-plastilina-02.webp" alt="Detalle de piezas artesanales colombianas de plastilina" loading="lazy" />
    </figure>
    <figure>
      <img src="${imageBase}/piezas-colombianas-plastilina-03.webp" alt="Rey y piezas artesanales de plastilina" loading="lazy" />
    </figure>
    <figure>
      <img src="${imageBase}/piezas-colombianas-plastilina-04.webp" alt="Conjunto de piezas de ajedrez hechas con plastilina" loading="lazy" />
    </figure>
    ...
    <figure>
      <img src="${imageBase}/ajedreces-reciclados-zaragoza-01.webp" alt="Ajedrez reciclado realizado en Zaragoza" loading="lazy" />
      <figcaption>Materiales reutilizados para crear piezas y tableros escolares.</figcaption>
    </figure>
    <figure>
      <img src="${imageBase}/ajedreces-reciclados-zaragoza-02.webp" alt="Segundo ajedrez reciclado realizado en Zaragoza" loading="lazy" />
    </figure>
    <figure>
      <img src="${imageBase}/ajedreces-reciclados-zaragoza-03.webp" alt="Detalle de piezas recicladas de ajedrez" loading="lazy" />
    </figure>
    <figure>
      <img src="${imageBase}/ajedreces-reciclados-zaragoza-04.webp" alt="Tablero escolar con piezas recicladas" loading="lazy" />
    </figure>
    ...
    <figure>
      <img src="${imageBase}/ajedreces-parets-valles-01.webp" alt="Ajedrez artesanal visto en Parets del Vallès" loading="lazy" />
    ...
    <figure>
      <img src="${imageBase}/ajedreces-bulgaros-01.webp" alt="Ajedrez búlgaro artesanal" loading="lazy" />
    ...
    <figure>
      <img src="${imageBase}/ajedreces-toledanos-01.webp" alt="Ajedrez toledano artesanal" loading="lazy" />
    ...
    <figure>
      <img src="${imageBase}/ajedrez-piedra-durango-01.webp" alt="Ajedrez de piedra en Durango" loading="lazy" />
    ...
    <figure>
      <img src="${imageBase}/ajedrez-piedras-rio-01.webp" alt="Ajedrez realizado con piedras de río" loading="lazy" />
    ...
    <figure>
      <img src="${imageBase}/concurso-chessland-jalisco-01.webp" alt="Primer trabajo del concurso de ajedreces artesanales de Chessland Academy" loading="lazy" />
      <figcaption>Trabajos presentados en una edición escolar dedicada a la creación de ajedreces.</figcaption>
    </figure>
    <figure>
      <img src="${imageBase}/concurso-chessland-jalisco-02.webp" alt="Segundo trabajo del concurso de ajedreces artesanales de Chessland Academy" loading="lazy" />
    </figure>
    <figure>
      <img src="${imageBase}/concurso-chessland-jalisco-03.webp" alt="Tercer trabajo del concurso de ajedreces artesanales de Chessland Academy" loading="lazy" />
    </figure>
    ...
    <figure>
      <img src="${imageBase}/ajedreces-artesanales-juan-francisco-01.webp" alt="Ajedrez artesanal de Juan Francisco López Fernández" loading="lazy" />
      <figcaption>Conjuntos artesanales que muestran distintas soluciones de diseño.</figcaption>
    </figure>
    <figure>
      <img src="${imageBase}/ajedreces-artesanales-juan-francisco-02.webp" alt="Segundo ajedrez artesanal de Juan Francisco López Fernández" loading="lazy" />
    </figure>
    <figure>
      <img src="${imageBase}/ajedreces-artesanales-juan-francisco-03.webp" alt="Detalle de ajedrez artesanal de Juan Francisco López Fernández" loading="lazy" />
    </figure>
    <figure>
      <img src="${imageBase}/ajedreces-artesanales-juan-francisco-04.webp" alt="Cuarto ajedrez artesanal de Juan Francisco López Fernández" loading="lazy" />
    </figure>
    ...
    <figure>
      <img src="${imageBase}/ajedreces-bambu-huevos-pasta-papel-01.webp" alt="Ajedrez artesanal realizado con bambú" loading="lazy" />
      <figcaption>Materiales cotidianos convertidos en recursos creativos para construir piezas.</figcaption>
    </figure>
    <figure>
      <img src="${imageBase}/ajedreces-bambu-huevos-pasta-papel-02.webp" alt="Ajedrez artesanal realizado con huevos" loading="lazy" />
    </figure>
    <figure>
      <img src="${imageBase}/ajedreces-bambu-huevos-pasta-papel-03.webp" alt="Segundo ajedrez artesanal realizado con huevos" loading="lazy" />
    </figure>
    <figure>
      <img src="${imageBase}/ajedreces-bambu-huevos-pasta-papel-04.webp" alt="Ajedrez artesanal realizado con pasta de papel" loading="lazy" />
    </figure>
    ...
    <figure>
      <img src="${imageBase}/ajedreces-maria-eugenia-marioni-01.webp" alt="Ajedrez artesanal de María Eugenia Marioni" loading="lazy" />
      <figcaption>Una muestra de ajedrez artesanal con fuerte presencia visual.</figcaption>
    </figure>
    <figure>
      <img src="${imageBase}/ajedreces-maria-eugenia-marioni-02.webp" alt="Ajedrez medieval artesanal de María Eugenia Marioni" loading="lazy" />
    </figure>
    <figure>
      <img src="${imageBase}/ajedreces-maria-eugenia-marioni-03.webp" alt="Ajedrez artesanal inspirado en charros y jarochos" loading="lazy" />
    </figure>
